...
const CoursesCard = ({
	...
	console.log("THIS IS ME HERE,",_id)
	return (
				...
				<div className="courses-image">
					...
					<div className="dropdown action-dropdown">
						...
						<ul className="dropdown-menu">
							<li>
								<Link href={`/instructor/course/edit/${_id}`}>
							...
							<li>
								<Link href={`/instructor/course/upload/${_id}`}>
									<a className="dropdown-item">
							...
							<li>
								<Link href={`/instructor/course/uploads/${_id}`}>
									<a className="dropdown-item">
							...
							<li>
								<Link href={`/instructor/course/assets/${_id}`}>
									<a className="dropdown-item">
