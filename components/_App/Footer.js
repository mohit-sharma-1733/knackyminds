	...
	return (
		<>
					...
					<div className="row">
						<div className="col-lg-3 col-sm-6">
							<div className="single-footer-widget">
								...
								<p>
								We Are Edmy! The Best Online Learning Platform
								</p>
							</div>
						</div>
						...
						<div className="col-lg-3 col-sm-6">
							<div className="single-footer-widget">
								...
								<ul className="info">
									...
									<li>
										<span>Address:</span>  Whitefield,
										Bengaluru,Karnataka IN 560067
									</li>
									<li>
										<span>Mail Us:</span>{" "}
			...
			<div className="copy-right-area bg-color-f6fafb">
				<div className="container">
					<p>
						&copy; Knackyminds {currentYear} is Proudly Owned by{" "}
